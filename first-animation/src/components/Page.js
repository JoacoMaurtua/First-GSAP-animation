      ...
      <div className="Wrapper">
        <div className="Info">
          <div className="CenterInfo">
            ...
            <p className="Titulo">
              Hip-hop, cultural movement that attained widespread popularity in
              the 1980s and ’90s; also, the backing music for rap, the musical
              style incorporating rhythmic and/or rhyming speech that became the
        ...
        <div className="Imagenes">
          <div className="Colum1">
            <img className="imagen" src={RapOne} alt="Rapper" />
          </div>
          <div className="Colum2">
            <img className="imagen" src={RapTwo} alt="Stage" />
          </div>
        </div>
      </div>
    </div>
